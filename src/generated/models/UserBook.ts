...
export type UserBookWhereInput = {
  ...
  status?: Prisma.StringFilter<"UserBook"> | string
...
export type UserBookScalarWhereWithAggregatesInput = {
  ...
  status?: Prisma.StringWithAggregatesFilter<"UserBook"> | string
...
export type UserBookOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "bookId" | "status" | "addedAt", ExtArgs["result"]["userBook"]>
...
export interface UserBookFieldRefs {
  ...
  readonly status: Prisma.FieldRef<"UserBook", 'String'>
